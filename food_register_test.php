<?php
	...
	echo $u_mail = stripslashes(trim($_POST['u_mail']));
	echo $u_pwd = stripslashes(trim($_POST['u_pwd']));
	echo $u_name = stripslashes(trim($_POST['u_name']));
	echo $u_phone = stripslashes(trim($_POST['u_phone']));
	// echo "string";
	...
	$sql = "INSERT INTO user (u_mail,u_pwd,u_name,u_phone,u_token,u_token_exptime,u_status,u_regtime) VALUES ('$u_mail','$u_pwd','$u_name','$u_phone','$token','$token_exptime',0,'$regtime')";
	...
	if(mysqli_query($link,$sql))
	{
	    ...
	    <a href='http://139.59.224.238/www/food/food_submit_3.php?verify=".$token."' target= 
		'_blank'>'http://139.59.224.238/www/food/food_submit_3.php?verify=".$token."</a><br/> 
